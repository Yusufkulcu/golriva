...
var IK = {
  ...
  uzak:'<svg class="ikon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="6" width="18" height="12" rx="6"/><circle cx="15" cy="12" r="3"/></svg>',
...
var MENU = [
  ...
  ['EKONOMİ', [
    ...
    ['referans','Referans Kodları','referans.html'],
  ]],
  ['SİSTEM', [
    ['uzak','Uzak Ayarlar','uzak_ayar.html'],
