...
/// RESPONSIVE KURAL: kok yerlesim kaydirilabilir (ListView) — kucuk ekran ve
...
class _EnKisaKadroScreenState extends State<EnKisaKadroScreen> {
          ...
          child: SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                _toplamKutu(adlar[0], t0, GolrivaColors.p1),
                _toplamKutu(adlar[1], t1, GolrivaColors.p2),
              ]),
              const SizedBox(height: 8),
              Text(
                  k == null
                      ? 'Rövanş şart.'
                      : '${(t0 - t1).abs()} cm farkla daha kısa kadro',
  ...
  Widget _toplamKutu(String ad, int cm, Color renk) => Column(children: [
        Text(ad.toUpperCase(),
          ...
          children: [
            ...
            if (adaylar.isNotEmpty)
              Container(
                ...
                // Material sarmalayici: InkWell/ListTile "invisible ink" uyarisini bitirir
                child: Material(
